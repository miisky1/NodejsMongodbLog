...
exports.findAll = function(collection,data,callback){
    __connectdb(function(db){
        db.db('190110910139').collection(collection).find(data).toArray(function(error,data){
            callback(error,data)
        })
    })
}
...
exports.insert = function(collection,data,callback){
    __connectdb(function(db){
        db.db('190110910139').collection(collection).insertOne(data,function(error,result){
...
exports.insertAll = function(collection,data,callback){
    __connectdb(function(db){
        db.db('190110910139').collection(collection).insertMany(data,function(error,result){
            callback(error,result)
        })
    })
}
...
exports.update = function(collection,data1,data2,callback){
    __connectdb(function(db){
        db.db('190110910139').collection(collection).updateOne(data1,{ $set:data2 },function(error,data){
            callback(error,data)
        })
    })
}
...
exports.delete = function(collection,data,callback){
    __connectdb(function(db){
        db.db('190110910139').collection(collection).deleteOne(data,function(error,data){
            callback(error,data)
        })
    })
}
...
exports.drop = function(collection){
    __connectdb(function(db){
        db.db('190110910139').collection(collection).drop()
    })
}
